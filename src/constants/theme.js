...
export const detailViewCloseIconSize = Layout.isSmallDevice ? wp('8%') : wp('8%');
export const overviewListSmallIconSize = Layout.isSmallDevice ? wp('5%') : wp('2.25%');
export const overviewListBigIconSize = Layout.isSmallDevice ? wp('15%') : wp('9%');
export const overviewListNumColumns = Layout.isSmallDevice ? 1 : 2;
export const settingsListItemIconSize = Layout.isSmallDevice ? wp('8%') : wp('5%');
export const overviewListIconBorderWidth = Layout.isSmallDevice ? wp('0.35%') : wp('0.25%');
...
export const headerImageWidth = Layout.isSmallDevice ? HEADER_WIDTH * hp(headerWPercent) : HEADER_WIDTH * hp(headerWPercent);
export const headerImageHeight = Layout.isSmallDevice ? HEADER_HEIGHT * hp(headerWPercent) : HEADER_HEIGHT * hp(headerWPercent);
export const headerHeight = headerImageHeight * 2.3;
export const headerFontSize = headerHeight * 0.35;
export const headerBottomSpace = headerHeight * (layout.isSmallDevice ? 2 : 1.5);
