...
export class SettingsList extends React.Component {
  ...
  _onValueChange = (key, value) => {
    ...
    this.props.saveValue && this.props.saveValue(key, value);
  };
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        <List borderColor="transparent">
          ...
          <List.Item
            title="Date Format"
            titleInfo={`Current: ${Moment(new Date()).format(
              settingsFormatValue
            )}`}
          ...
          <List.Item
            ...
            onPress={() =>
              this.props.navigation.navigate(PRIVACY_POLICY_SCREEN)
            }
          />
          <List.Item
            title="Credits"
          ...
          <List.Item
            title="Support"
            hasNavArrow={true}
            icon={<SettingsListItemIcon name="gift" />}
            arrowIcon={<Arrow />}
            titleStyle={settingsStyle.titleStyle}
            titleBoxStyle={settingsStyle.titleBoxStyle}
            arrowStyle={arrowStyle}
